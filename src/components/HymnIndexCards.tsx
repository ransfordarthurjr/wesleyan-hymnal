...
export const HymnIndexFirstLineCard = ({
    ...
    return (
        <Link
            ...
            <View
                className={cn(
                    'flex-row items-center gap-x-4 border rounded-md px-4 py-2.5',
                    first && 'rounded-t-2xl',
                    last && 'rounded-b-2xl',
                    hymn.ordinal % 5 === 1 && 'rounded-t-2xl',
                    hymn.ordinal % 5 === 0 && 'rounded-b-2xl mb-8',
                    ...
                    scheme === 'sky' && 'border-sky-200 bg-sky-50',
                )}>
                <IconSvg
                    className={cn(
...
export const HymnIndexGridCard = ({
    hymn,
    first = false,
    last = false,
    scheme = 'slate',
    ...
    return (
        <Link
            ...
            <View
                className={cn(
                    'flex-1 items-center justify-center border rounded-xl px-4 py-4',
                    scheme === 'slate' && 'border-slate-200 bg-slate-100',
                    scheme === 'red' && 'border-red-200 bg-red-100',
                    scheme === 'orange' && 'border-orange-200 bg-orange-100',
                    scheme === 'green' && 'border-green-200 bg-green-100',
                    scheme === 'teal' && 'border-teal-200 bg-teal-100',
                    scheme === 'cyan' && 'border-cyan-200 bg-cyan-100',
                    scheme === 'blue' && 'border-blue-200 bg-blue-100',
                    scheme === 'violet' && 'border-violet-200 bg-violet-100',
                    scheme === 'fuchsia' && 'border-fuchsia-200 bg-fuchsia-100',
                    scheme === 'rose' && 'border-rose-200 bg-rose-100',
                    scheme === 'sky' && 'border-rose-200 bg-sky-100',
                )}>
                <Text
                    className={cn(
                        'font-googlesans-medium text-2xl',
...
export const HymnIndexFavouriteCard = ({
    hymn,
    first = false,
    last = false,
    scheme = 'slate',
    ...
    return (
        <Link
            ...
            <View
                className={cn(
                    'flex-row items-center gap-x-4 border rounded-md px-4 py-3',
                    first && 'rounded-t-2xl',
                    last && 'rounded-b-2xl',
                    scheme === 'slate' && 'border-slate-200 bg-slate-50',
                    scheme === 'red' && 'border-red-200 bg-red-50',
                ...
                <Text
                    className={cn(
                        'font-googlesans-medium text-xl w-10',
                        scheme === 'slate' && 'text-slate-900',
                        scheme === 'red' && 'text-red-900',
                        scheme === 'orange' && 'text-orange-900',
                        scheme === 'green' && 'text-green-900',
...
export const HymnFavouriteCard = ({
    hymn,
    first = false,
    last = false,
    scheme = 'slate',
    ...
    return (
        <Link
            ...
            <View
                className={cn(
                    'flex-row items-center gap-x-4 border rounded-md p-4 pl-6',
                    first && 'rounded-t-2xl',
                    last && 'rounded-b-2xl',
                    scheme === 'slate' && 'border-slate-200 bg-slate-50',
                    scheme === 'red' && 'border-red-200 bg-red-50',
                ...
                <View className="shrink-0 flex-row items-center justify-start w-10">
                    <Text
                        className={cn(
                            'font-googlesans-medium text-xl ',
                            scheme === 'slate' && 'text-slate-900',
                            scheme === 'red' && 'text-red-900',
                            scheme === 'orange' && 'text-orange-900',
                            scheme === 'green' && 'text-green-900',
